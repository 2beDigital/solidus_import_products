...
Spree::ProductImport.settings = {
    ...
    :image_fields_products => [:image_product, :image_product_2, :image_product_3, :image_product_4], #Image fields that should be parsed for image locations
    :image_fields_variants => [:image_variant, :image_variant_2, :image_variant_3, :image_variant_4], #Image fields that should be parsed for image locations
    ...
    :variant_comparator_field_i18n => :slugi18n, #CSV column with translation of variant_comparator_field
